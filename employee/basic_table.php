...
<?php 
  ...
  if(isset($_SESSION['employee_id'])){
    ...
    while($row_bin = mysqli_fetch_assoc($check_date)){
      $cust_id1 = $row_bin['user_id'];
      $cust_fullname = $row_bin['fullname'];
      $employ_fullname = $row_bin['employee_name'];
      $services = $row_bin['service_name'];
     
      $insert_cur_date = mysqli_query($connect, "INSERT INTO bin (cust_id, cust_fullname, employ_fullname, services, reserved_condition) VALUES('$cust_id1' ,'$cust_fullname', '$employ_fullname', '$services', '1')");
    ...
    $populatedatatotable = mysqli_query($connect, "SELECT * FROM booking WHERE employee_id='$employee_id' AND booking_condition='0' ORDER BY date_reserved");
      ...
      if($verify_customer){
        if(is_numeric($verify_customer)){
          ...
          if($check){
            ...
            $get_employ_fullname = $fetch_customer_id['employee_name'];
            ...
            if($add_sales && $result){
              ...
              $succes_bin = mysqli_query($connect, "INSERT INTO bin (cust_id, cust_fullname, employ_fullname, services, reserved_condition) VALUES ('$get_user_id', '$get_fullname', '$get_employ_fullname', '$get_services', '2')");
              if($succes_bin){
                ...
                if($updated){
                  ...
                  if($deleted){
                    echo "<script>window.location.href='basic_table.php?reserved=succesfully';</script>";
                  }
                  else{
                    echo "error";
                  }
              ...
              echo "<script>window.location.href='basic_table.php?invalid=failed';</script>";
            }
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <?php echo $reserved_done;?>
            <p style="color:red;"><?php echo $verify_customerErr;?></p>
            <form method="post">
          ...
          <div class="col-lg-12">
            ...
            <section class="panel">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    <th><i class="fas fa-user"></i>Barber ID</th>
                    <th><i class="fas fa-id-card-alt"></i>User ID</th>
              ...
              <tr>
                    ...
                    <td>
                       <div class="btn-group">
                        <a class="btn btn-primary" href="tester.php?haircut_id=<?php echo $db_haircut_id;?>" name="done"><i class="fas fa-check" style="font-size:13px;"></i></a>
                      </div>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="delete.php?user_id=<?php echo $db_haircut_id;
                        ?>"><i class="far fa-trash-alt" style="font-size:13px;"></i></a>
                      </div>
                    </td>
                  </tr>  
              <?php
